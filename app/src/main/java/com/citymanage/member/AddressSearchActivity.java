        ...
        selectConfirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DialogInterface.OnClickListener confirmListener = new DialogInterface.OnClickListener(){
                    ...
                    MemberService service = retrofit.create(MemberService.class);
                    final Call<MemberRepo> repos = service.setCityStateInfoRegister(Module.getRecordId(getApplicationContext()),Module.getRecordPwd(getApplicationContext())
                            , cityList.get(citySp.getSelectedItemPosition()).get("cityCode"), stateList.get(stateSp.getSelectedItemPosition()).get("stateCode"));

                    repos.enqueue(new Callback<MemberRepo>(){
                        @Override
                        public void onResponse(Call<MemberRepo> call, Response<MemberRepo> response) {

                            MemberRepo memberInfo = response.body();
                            ...
                            if(memberInfo != null) {
                                ...
                                Toast.makeText(AddressSearchActivity.this, memberInfo.getResultMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }
